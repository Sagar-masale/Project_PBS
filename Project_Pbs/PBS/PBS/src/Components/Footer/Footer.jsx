    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            ...
            <span className="Footer-Pbs-Name ml-5 text-2xl">
                ...
                <p className="py-8 text-sm text-gray-500 lg:max-w-xs text-left lg:text-left">Have any query? Please contact us.
                Our team is here to assist you with any questions or concerns. Feel free to reach out for personalized support and guidance.</p>
                <a href="javascript:;"  className="py-2.5 px-5 h-9 block w-fit bg-[#4f3267] rounded-full shadow-sm text-xs text-white mx-auto transition-all  duration-500 hover:bg-[#432a58] lg:mx-0">
                    Contact us
                </a>
            </div>
            ...
            <div className="lg:mx-auto text-left ">
                ...
                <ul className="text-sm  transition-all duration-500">
                    <Link to="/"><li className="mb-6"><a href="javascript:;"  className="text-gray-600 hover:text-gray-900">Home</a></li></Link>
        ...
        <div className="py-7 border-t border-gray-200">
            <div className="flex items-center justify-center flex-col lg:justify-between lg:flex-row">
                <span className="text-sm text-gray-500 ">©<a href="#">PBS</a> 2024, All rights reserved.</span>
                <div className="flex mt-4 space-x-4 sm:justify-center lg:mt-0 ">
                    <a href="javascript:;"  className="w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#4f3267] hover:bg-gray-900">
                    ...
                    <a href="https://www.instagram.com/p.b.salegaon_jewellers_/?igshid=NzZlODBkYWE4Ng%3D%3D"  className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[linear-gradient(45deg,#FEE411_6.9%,#FEDB16_10.98%,#FEC125_17.77%,#FE983D_26.42%,#FE5F5E_36.5%,#FE2181_46.24%,#9000DC_85.57%)]  hover:bg-gradient-to-b from-gray-900 to-gray-900  
                    ">
                    ...
                    <a href="javascript:;"  className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#2162d3]  hover:bg-gray-900 ">
                    ...
                    <a href="javascript:;"  className="relative w-8 h-8 rounded-full transition-all duration-500 flex justify-center items-center bg-[#ff0000ac]  hover:bg-gray-900 ">
