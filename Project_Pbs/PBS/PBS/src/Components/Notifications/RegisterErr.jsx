...
function RegisterErr() {
  ...
  useEffect(() => {
    if (registerErrStatus) {
      setShowUnSuccess(true); // Show the error message
  ...
  }, [registerErrStatus]); // Only re-run when `registerStatus` changes
    
  return (
    <>
<div className={`cardErr ${showUnSuccess? 'cardErr-Unsuccess' : ''}`}>
  <svg className="waveErr" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
    <path
  ...
  <div className="message-text-containerErr">
    <p className="message-textErr">Error message</p>
    <p className="sub-textErr">Something went wrong</p>
  </div>
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 15 15"
