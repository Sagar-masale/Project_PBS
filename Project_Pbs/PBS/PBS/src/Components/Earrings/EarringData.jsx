const EarringsData = [
  {
    id: 1,
    img: './Erraings/imgR.jpg',
    moreImages: [
      './Erraings/imgRM1.jpg',
      './Erraings/imgRM2.jpg',
      './Erraings/imgR.jpg',
    ],
    stocks: 'ONLY 6 LEFT IN STOCK',
    stocksQty: 6, // Added stocksQty
  ...
  {
    id: 2,
    img: './Erraings/imgR2.jpg',
    moreImages: [
      './Erraings/imgR2M1.jpg',
      './Erraings/imgR2M2.jpg',
      './Erraings/imgR2.jpg',
    ],
    stocks: 'ONLY 2 LEFT IN STOCK',
    stocksQty: 2, // Added stocksQty
  ...
  {
    id: 3,
    img: './Erraings/imgR3.jpg',
    moreImages: [
      './Erraings/imgR3M1.jpg',
      './Erraings/imgR3M2.jpg',
      './Erraings/imgR3.jpg',
    ],
    stocks: 'ONLY 5 LEFT IN STOCK',
    stocksQty: 5, // Added stocksQty
  ...
  {
    id: 4,
    img: './Erraings/imgR4.jpg',
    moreImages: [
      './Erraings/imgR4M1.jpg',
      './Erraings/imgR4.jpg',
      './Erraings/imgR4M1.jpg',
    ],
    stocks: 'ONLY 5 LEFT IN STOCK',
  ...
  {
    id: 5,
    img: './Erraings/imgR5.jpg',
    moreImages: [
      './Erraings/imgR5M1.jpg',
      './Erraings/imgR5M2.jpg',
      './Erraings/imgR5.jpg',
    ],
    stocks: 'ONLY 8 LEFT IN STOCK',
    stocksQty: 8, // Added stocksQty
  ...
  {
    id: 6,
    img: './Erraings/imgR6.jpg',
    moreImages: [
      './Erraings/imgR6M1.jpg',
      './Erraings/imgR6M2.jpg',
      './Erraings/imgR6.jpg',
    ],
    stocks: 'ONLY 5 LEFT IN STOCK',
    stocksQty: 5, // Added stocksQty
  ...
  {
    id: 7,
    img: './Erraings/imgR7.jpg',
    moreImages: [
      './Erraings/imgR7M1.jpg',
      './Erraings/imgR7M2.jpg',
      './Erraings/imgR7.jpg',
    ],
    stocks: 'ONLY 5 LEFT IN STOCK',
    stocksQty: 5, // Added stocksQty
