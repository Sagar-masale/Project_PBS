...
function SliderBarForPhn() {
  ...
  return (
    <>
<div className="flex flex-col h-full p-3 w-full dark:bg-gray-50 dark:text-gray-800">
	<div className="space-y-3">
		...
		<div className="relative">
			...
			<input type="search" name="Search" placeholder="Search..." className="search focus:ring-0 w-full py-2 pl-10 text-sm dark:border- rounded-md focus:outline-none dark:bg-gray-100 dark:text-gray-800 " />
		</div>
		<div className="flex-1">
			<ul className="pt-2 pb-4 space-y-1 text-sm flex flex-col gap-3">
	...
	<div className="flex items-center p-2 mt-10 space-x-4 justify-self-end">
